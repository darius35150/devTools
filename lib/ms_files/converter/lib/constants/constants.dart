class Constants {
  ...
  static String ONE_TO_MANY = '@OneToMany';
  static String MANY_TO_ONE = '@ManyToOne';
  static String SEQ_GENERATOR = '@SequenceGenerator';
  static String TRANSIENT = '@Transient';
  static String EMBEDDED_ID = '@EmbeddedId';
  static String GENERATED_VALUE = '@GeneratedValue';
  static String JOIN_COLUMN = '@JoinColumn';
  static String JSON_BACK_REF = '@JsonBackReference';
  static String JSON_MANAGED_REF = '@JsonManagedReference';
  static String NOT_NULL = '@NotNull';
